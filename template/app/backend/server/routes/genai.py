"""GenAI capabilities for Capitec Sentinel:
...
GENIE_SPACE = os.environ.get("SENTINEL_GENIE_SPACE", "01f194ad316e127191fec45fdd5fb6bc")
...
def exec_briefing():
    ...
    prompt = (
        "You are a Chief Compliance Officer's AI analyst for Capitec Bank Limited, a South "
